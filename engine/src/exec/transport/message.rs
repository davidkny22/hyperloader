...
pub struct DispatchMessage {
    ...
    pub worker: u32,
    /// Number of contiguous batch positions, or zero for a scalar command.
    pub batch_len: u32,
